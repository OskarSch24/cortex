...
import { suggestRules, type Correction, type SuggestedRule } from '@cortex/core';

const CORRECTIONS_KEY = 'cortex.corrections';
const PREFERENCES_KEY = 'cortex.preferences';
const DISMISSED_KEY = 'cortex.dismissedRules';
