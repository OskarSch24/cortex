...
export interface TaskMetric {
  ...
  retried?: boolean;
  /**
   * The user marked the answer as poor. The strongest signal there is — it is
   * the only one they had to go out of their way to give — so it counts the
   * same as steering: this run does not get to look clean.
   */
  ratedPoor?: boolean;
