...
const TIER_MODELS: Record<ProviderId, Record<Tier, string | undefined>> = {
  claude: { light: 'sonnet', standard: 'sonnet', heavy: 'opus' },
...
const KIND_AFFINITY: Record<TaskKind, Partial<Record<ProviderId, number>>> = {
  question: { claude: 0.9, codex: 0.85, copilot: 0.8, grok: 0.9 },
  explain: { claude: 0.95, codex: 0.85, copilot: 0.8, grok: 0.9 },
  edit: { claude: 0.95, codex: 0.95, copilot: 0.85, grok: 0.9 },
  debug: { claude: 0.95, codex: 0.9, copilot: 0.8, grok: 0.9 },
  test: { claude: 0.9, codex: 0.95, copilot: 0.85, grok: 0.85 },
  review: { claude: 0.95, codex: 0.85, copilot: 0.8, grok: 0.9 },
  refactor: { claude: 0.95, codex: 0.9, copilot: 0.8, grok: 0.85 },
  docs: { claude: 0.9, codex: 0.85, copilot: 0.8, grok: 0.85 },
  agentic: { claude: 0.95, codex: 0.95, copilot: 0.8, grok: 0.95 },
};
